...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    valor_real = (temperature * neutrons_produced_per_second)
    limite_inferior = (threshold * 0.90)
    limite_superior = (threshold * 1.10)

    if valor_real < limite_inferior:
        return "LOW"
    elif limite_superior >= valor_real >= limite_inferior:
        return "NORMAL"
    else:
        return "DANGER"
