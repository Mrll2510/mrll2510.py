...
def make_word_groups(vocab_words):
    ...
    palavras = vocab_words[1:]
    lista_final = [prefixo] + [prefixo + palavra for palavra in palavras]
...
def adjective_to_verb(sentence, index):
    ...
    palavra = palavras[index].rstrip(".")
    return palavra + "en"

print(adjective_to_verb("I need to make that brigt", -1))
